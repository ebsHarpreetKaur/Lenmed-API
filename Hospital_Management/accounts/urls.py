...
from accounts.views import login, RegisterUsers, DeleteUser, HandleRole, HandleHospitalAndAdmin, handlePermissions, ChangePassword, password_reset_request, password_reset, UpdateUser
